				...
				<div class="as-double-group as-clearfix">
					<div class="as-form-group">
						...
						<select name="customizewoo_loop_shop_per_page" id="customizewoo_loop_shop_per_page">
							...
							for ( $i = 1; $i < 100; $i++ ) {
								echo '<option value="' . esc_attr( $i ) . '"' . selected( esc_attr( $options['loop_shop_per_page'] ), esc_attr( $i ) ) . '>' . esc_html( $i ) . '</option>';
							}
					...
					<div class="as-form-group">
						...
						<select name="customizewoo_loop_shop_columns" id="customizewoo_loop_shop_columns">
							<?php
								...
								// Loading font sizes with the help of a loop.
							for ( $i = 1; $i < 100; $i++ ) {
								echo '<option value="' . esc_attr( $i ) . '"' . selected( esc_attr( $options['loop_shop_columns'] ), esc_attr( $i ) ) . '>' . esc_html( $i ) . '</option>';
							}
