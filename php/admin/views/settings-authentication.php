			...
			<div class="as-section-content">
				<div class="as-double-group as-clearfix">
					<div class="as-form-group">
						...
						<input type="text" name="customizewoo_lost_password_message" id="customizewoo_lost_password_message" value="<?php echo esc_attr( stripslashes( $options['lost_password_message'] ) ); ?>" placeholder="<?php esc_attr_e( 'Lost password text', 'customize-woo' ); ?>" class="as-form-control">
					...
					<div class="as-form-group">
						...
						<input type="text" name="customizewoo_lost_password_confirmation_message" id="customizewoo_lost_password_confirmation_message" value="<?php echo esc_attr( stripslashes( $options['lost_password_confirmation_message'] ) ); ?>" placeholder="<?php esc_attr_e( 'Lost password confirmation message', 'customize-woo' ); ?>" class="as-form-control">
				...
				<div class="as-double-group as-clearfix">
					<div class="as-form-group">
						...
						<input type="text" name="customizewoo_reset_password_message" id="customizewoo_reset_password_message" value="<?php echo esc_attr( stripslashes( $options['reset_password_message'] ) ); ?>" placeholder="<?php esc_attr_e( 'Reset password text', 'customize-woo' ); ?>" class="as-form-control">
