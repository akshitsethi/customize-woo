			...
			<div class="as-section-content">
				<div class="as-double-group as-clearfix">
					<div class="as-form-group">
						...
						<input type="text" name="customizewoo_no_shipping_available_html" id="customizewoo_no_shipping_available_html" value="<?php echo esc_attr( stripslashes( $options['woocommerce_no_shipping_available_html'] ) ); ?>" placeholder="<?php esc_attr_e( 'No shipping available text on cart page', 'customize-woo' ); ?>" class="as-form-control">
					...
					<div class="as-form-group">
						...
						<input type="text" name="customizewoo_shipping_estimate_html" id="customizewoo_shipping_estimate_html" value="<?php echo esc_attr( stripslashes( $options['woocommerce_shipping_estimate_html'] ) ); ?>" placeholder="<?php esc_attr_e( 'Shipping estimate text on cart page', 'customize-woo' ); ?>" class="as-form-control">
