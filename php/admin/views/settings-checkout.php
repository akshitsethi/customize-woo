			...
			<div class="as-section-content">
				...
				<div class="as-double-group as-clearfix">
					<div class="as-form-group">
						...
						<select name="customizewoo_create_account_default_checked" id="customizewoo_create_account_default_checked">
							<option value="checked"<?php echo selected( esc_attr( $options['create_account_default_checked'] ), 'checked' ); ?>><?php esc_html_e( 'Checked', 'customize-woo' ); ?></option>
							<option value="unchecked"<?php echo selected( esc_attr( $options['create_account_default_checked'] ), 'unchecked' ); ?>><?php esc_html_e( 'Unchecked', 'customize-woo' ); ?></option>
						</select>
					...
					<div class="as-form-group">
						...
						<input type="text" name="customizewoo_order_button_text" id="customizewoo_order_button_text" value="<?php echo esc_attr( stripslashes( $options['order_button_text'] ) ); ?>" placeholder="<?php esc_attr_e( 'Place order button text on product page', 'customize-woo' ); ?>" class="as-form-control">
				...
				<div class="as-double-group as-clearfix">
					<div class="as-form-group">
						...
						<input type="checkbox" class="as-form-ios" name="customizewoo_show_terms" value="1"<?php checked( true, esc_attr( $options['show_terms'] ) ); ?>>
					...
					<div class="as-form-group">
						...
						<input type="checkbox" class="as-form-ios" name="customizewoo_order_notes_field" value="1"<?php checked( true, esc_attr( $options['order_notes_field'] ) ); ?>>
