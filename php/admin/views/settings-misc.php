			...
			<div class="as-section-content">
				<div class="as-double-group as-clearfix">
					<div class="as-form-group">
						...
						<input type="text" name="customizewoo_countries_tax_or_vat" id="customizewoo_countries_tax_or_vat" value="<?php echo esc_attr( stripslashes( $options['countries_tax_or_vat'] ) ); ?>" placeholder="<?php esc_attr_e( 'Taxes label text', 'customize-woo' ); ?>" class="as-form-control">
					...
					<div class="as-form-group">
						...
						<input type="text" name="customizewoo_countries_inc_tax_or_vat" id="customizewoo_countries_inc_tax_or_vat" value="<?php echo esc_attr( stripslashes( $options['countries_inc_tax_or_vat'] ) ); ?>" placeholder="<?php esc_attr_e( 'Including taxes label text', 'customize-woo' ); ?>" class="as-form-control">
				...
				<div class="as-double-group as-clearfix">
					<div class="as-form-group">
						...
						<input type="text" name="customizewoo_countries_ex_tax_or_vat" id="customizewoo_countries_ex_tax_or_vat" value="<?php echo esc_attr( stripslashes( $options['countries_ex_tax_or_vat'] ) ); ?>" placeholder="<?php esc_attr_e( 'Excluding taxes label text', 'customize-woo' ); ?>" class="as-form-control">
					...
					<div class="as-form-group">
						...
						<input type="text" name="customizewoo_order_received_text" id="customizewoo_order_received_text" value="<?php echo esc_attr( stripslashes( $options['order_received_text'] ) ); ?>" placeholder="<?php esc_attr_e( 'Order received thank you text', 'customize-woo' ); ?>" class="as-form-control">
