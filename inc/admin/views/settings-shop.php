			...
			<div class="as-section-content">
				<div class="as-double-group as-clearfix">
					<div class="as-form-group">
						<label for="<?php echo Config::PREFIX . 'add_to_cart_text'; ?>" class="as-strong"><?php esc_html_e( 'Simple Product', 'customize-woo' ); ?></label>
						<input type="text" name="<?php echo Config::PREFIX . 'add_to_cart_text'; ?>" id="<?php echo Config::PREFIX . 'add_to_cart_text'; ?>" value="<?php echo esc_attr( stripslashes( $options['add_to_cart_text'] ) ); ?>" placeholder="<?php esc_attr_e( 'Add to Cart button text for simple products', 'customize-woo' ); ?>" class="as-form-control">
				...
				<div class="as-double-group as-clearfix">
					<div class="as-form-group">
						<label for="<?php echo Config::PREFIX . 'grouped_add_to_cart_text'; ?>" class="as-strong"><?php esc_html_e( 'Grouped Product', 'customize-woo' ); ?></label>
						<input type="text" name="<?php echo Config::PREFIX . 'grouped_add_to_cart_text'; ?>" id="<?php echo Config::PREFIX . 'grouped_add_to_cart_text'; ?>" value="<?php echo esc_attr( stripslashes( $options['grouped_add_to_cart_text'] ) ); ?>" placeholder="<?php esc_attr_e( 'Add to Cart button text for grouped products', 'customize-woo' ); ?>" class="as-form-control">
				...
				<div class="as-double-group as-clearfix">
					<div class="as-form-group">
						<label for="<?php echo Config::PREFIX . 'external_add_to_cart_text'; ?>" class="as-strong"><?php esc_html_e( 'External Product', 'customize-woo' ); ?></label>
						<input type="text" name="<?php echo Config::PREFIX . 'external_add_to_cart_text'; ?>" id="<?php echo Config::PREFIX . 'external_add_to_cart_text'; ?>" value="<?php echo esc_attr( stripslashes( $options['external_add_to_cart_text'] ) ); ?>" placeholder="<?php esc_attr_e( 'Add to Cart button text for external products', 'customize-woo' ); ?>" class="as-form-control">

						<p class="as-form-help-block"><?php esc_html_e( 'Changes the add to cart button text for external products.', 'customize-woo' ); ?></p>
					</div>

					<div class="as-form-group">
						<label for="<?php echo Config::PREFIX . 'loop_sale_flash_text'; ?>" class="as-strong"><?php esc_html_e( 'Sale Badge Text', 'customize-woo' ); ?></label>
						<input type="text" name="<?php echo Config::PREFIX . 'loop_sale_flash_text'; ?>" id="<?php echo Config::PREFIX . 'loop_sale_flash_text'; ?>" value="<?php echo esc_attr( stripslashes( $options['loop_sale_flash_text'] ) ); ?>" placeholder="<?php esc_attr_e( 'Add text for Sale badge', 'customize-woo' ); ?>" class="as-form-control">
				...
				<div class="as-double-group as-clearfix">
					<div class="as-form-group">
						<label for="<?php echo Config::PREFIX . 'loop_shop_per_page'; ?>" class="as-strong"><?php esc_html_e( 'Products Displayed Per Page', 'customize-woo' ); ?></label>
					...
					<div class="as-form-group">
						<label for="<?php echo Config::PREFIX . 'loop_shop_columns'; ?>" class="as-strong"><?php esc_html_e( 'Product Columns Displayed Per Page', 'customize-woo' ); ?></label>
				...
				<div class="as-double-group as-clearfix">
					<div class="as-form-group">
						<label for="<?php echo Config::PREFIX . 'product_thumbnails_columns'; ?>" class="as-strong"><?php esc_html_e( 'Product Thumbnail Columns Displayed', 'customize-woo' ); ?></label>
