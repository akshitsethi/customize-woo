...
class Config {
	...
	public function default_options() {
		self::$default_options = array(
			...
			'woocommerce_description_tab_title'            => esc_html__( 'Description', 'woo-customizer' ),
			'woocommerce_additional_information_tab_title' => esc_html__( 'Additional Information', 'woo-customizer' ),
			'woocommerce_description_heading'              => esc_html__( 'Description', 'woo-customizer' ),
			'woocommerce_additional_information_heading'   => esc_html__( 'Additional Information', 'woo-customizer' ),
