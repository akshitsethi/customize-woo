...
class Config {
	...
	public function default_options() {
		self::$default_options = array(
			'add_to_cart_text'                           => esc_html__( 'Add to Cart', 'woo-customizer' ),
			'variable_add_to_cart_text'                  => esc_html__( 'Select Options', 'woo-customizer' ),
			'grouped_add_to_cart_text'                   => esc_html__( 'View Options', 'woo-customizer' ),
			'out_of_stock_add_to_cart_text'              => esc_html__( 'Out of Stock', 'woo-customizer' ),
			'external_add_to_cart_text'                  => esc_html__( 'Read More', 'woo-customizer' ),
			...
			'woocommerce_product_description_tab_title'  => esc_html__( 'Description', 'woo-customizer' ),
			'woocommerce_product_description_heading'    => esc_html__( 'Description', 'woo-customizer' ),
			'woocommerce_product_reviews_tab_title'      => esc_html__( 'Reviews', 'woo-customizer' ),
			'woocommerce_product_additional_information_tab_title' => esc_html__( 'Additional Information', 'woo-customizer' ),
			'woocommerce_product_additional_information_heading' => esc_html__( 'Additional Information', 'woo-customizer' ),
			'single_add_to_cart_text'                    => esc_html__( 'Add to Cart', 'woo-customizer' ),
