	...
	<form method="post" class="as-product-form">
		...
		<div class="as-double-group as-clearfix">
					<div class="as-form-group">
						...
						<input type="text" name="<?php echo Config::PREFIX . 'single_add_to_cart_text'; ?>" id="<?php echo Config::PREFIX . 'single_add_to_cart_text'; ?>" value="<?php echo esc_attr( stripslashes( $options['single_add_to_cart_text'] ) ); ?>" placeholder="<?php esc_attr_e( 'Add to Cart text for all product types', 'woo-customizer' ); ?>" class="as-form-control">
					...
					<div class="as-form-group">
						...
						<input type="text" name="<?php echo Config::PREFIX . 'single_out_of_stock_text'; ?>" id="<?php echo Config::PREFIX . 'single_out_of_stock_text'; ?>" value="<?php echo esc_attr( stripslashes( $options['single_out_of_stock_text'] ) ); ?>" placeholder="<?php esc_attr_e( 'Out of Stock text on product page', 'woo-customizer' ); ?>" class="as-form-control">
		...
		<div class="as-double-group as-clearfix">
					<div class="as-form-group">
						...
						<input type="text" name="<?php echo Config::PREFIX . 'single_backorder_text'; ?>" id="<?php echo Config::PREFIX . 'single_backorder_text'; ?>" value="<?php echo esc_attr( stripslashes( $options['single_backorder_text'] ) ); ?>" placeholder="<?php esc_attr_e( 'Backorder text on product page', 'woo-customizer' ); ?>" class="as-form-control">
					...
					<div class="as-form-group">
						...
						<input type="text" name="<?php echo Config::PREFIX . 'single_sale_flash_text'; ?>" id="<?php echo Config::PREFIX . 'single_sale_flash_text'; ?>" value="<?php echo esc_attr( stripslashes( $options['single_sale_flash_text'] ) ); ?>" placeholder="<?php esc_attr_e( 'Sale badge text on product page', 'woo-customizer' ); ?>" class="as-form-control">
